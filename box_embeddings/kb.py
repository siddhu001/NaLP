    ...
    def __init__(self, filename, em=None, rm=None, add_unknowns=True):
        ...
        with open(filename) as f:
            ...
            for l in lines:
                ...
                # can throw an error if UNK relations
                #facts.append([self.entity_map.get(l[2], len(self.entity_map) - 1), self.relation_map.get(l[1], len(self.relation_map) - 1) + 1,
                #             self.entity_map.get(l[0], len(self.entity_map) - 1)])
