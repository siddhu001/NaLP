...
def main(dataset_root, save_dir, model_name, model_arguments, loss_function, loss_arguments, learning_rate, batch_size,
         regularization_coefficient, gradient_clip, optimizer_name, max_epochs, negative_sample_count, hooks,
         eval_every_x_epochs, eval_batch_size, resume_from_save, introduce_oov, verbose):
    ...
    tr = trainer.Trainer(scoring_function, scoring_function.regularizer, loss, optim, ktrain, kvalid, ktest,
    ...
    tr.start(max_epochs, [(eval_every_x_epochs*ktrain.facts.shape[0]/batch_size)//20, 20], mb_start,learning_rate)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-f', '--loss_arguments', help="loss arguments as in __init__ of "
                                                        "loss"
    ...
    parser.add_argument('-x', '--eval_every_x_epochs', required=False, type=int, default=2000)
    ...
    if arguments.loss_arguments:
        arguments.loss_arguments = json.loads(arguments.loss_arguments)
    ...
    main(dataset_root, arguments.save_dir, arguments.model, arguments.model_arguments, arguments.loss, arguments.loss_arguments,
         ...
         arguments.eval_every_x_epochs, arguments.eval_batch_size, arguments.resume_from_save,
